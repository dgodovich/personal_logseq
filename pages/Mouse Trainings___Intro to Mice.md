...
- Euthanasia has several acceptable methods
	...
	- CO2 is only acceptable from compressed gas cylinder / building
		- Slow addition mixes with air and anesthetizes prior to asphyxiation
		- Must verify that the animal is dead
	- Cervical dislocation
		- must have demonstrated technical competence
	- Decapitation
		- Need training and need to show that you need undamaged brain
	- Specific instruments that do microwave irradiation are ok
	- Tribromoethanol can be used with specific reasons
	- Neonatal euthanasia
		- Need to use prolonged exposure to CO2, so this isn't advised
		- Cervical dislocation / decapitation / barbiturates is better